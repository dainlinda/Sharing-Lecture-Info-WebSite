...
<%
	...
	sql = "select ID,SUBJECT,NAME,AVG(HOMEWORK) as HOMEWORK,AVG(FUN) as FUN,AVG(BENEFIT) as BENEFIT,AVG(DIFFICULTY) as DIFFICULTY,AVG(FAVOR) as FAVOR,SUBSTRING(ID,1,2) as MAJOR from lecture group by ID";
	pstmt = conn.prepareStatement(sql);
	rs = pstmt.executeQuery();			
%>	
